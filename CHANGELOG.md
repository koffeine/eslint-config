...
- Updated @stylistic/eslint-plugin to 5.9.0
...
- Updated @stylistic/eslint-plugin to 5.8.0
...
- Updated @stylistic/eslint-plugin to 5.7.1
...
- Updated @stylistic/eslint-plugin to 5.6.1
...
- Updated @stylistic/eslint-plugin to 5.6.0
...
- Updated @stylistic/object-curly-spacing rule with `'always', { arraysInObjects: true, objectsInObjects: true, emptyObjects: 'never' }`
...
- Updated @stylistic/eslint-plugin to 5.4.0
...
- Fixed eslint version in peerDependencies
...
- Enabled preserve-caught-error rule with `{ requireCatchParameter: false }`
...
- Updated @stylistic/eslint-plugin to 5.2.3
...
- Updated @stylistic/eslint-plugin to 5.2.1
...
- Updated no-inner-declarations rule with `'both', { blockScopedFunctions: 'allow' }`
- Updated eslint to 9.31.0
...
- Disabled @stylistic/lines-around-comment rule
...
- Updated @stylistic/eslint-plugin to 5.1.0
...
- Changed export to a config array instead of a config object
...
- Updated eslint to 9.30.0
- Updated no-duplicate-imports rule with `{ includeExports: true, allowSeparateTypeImports: false }`
...
- Updated @stylistic/eslint-plugin to 5.0.0
...
- Updated @stylistic/eslint-plugin to 4.4.1
...
- Migrated to @stylistic/eslint-plugin@4.4.0 from @stylistic/eslint-plugin-js@4.3.0
...
- Updated @stylistic/eslint-plugin-js to 4.3.0
...
- Updated eslint to 9.27.0
- Enabled no-unassigned-vars rule
...
- Updated @stylistic/eslint-plugin-js to 4.2.0
...
- Updated @stylistic/eslint-plugin-js to 4.1.0
...
- Updated @stylistic/eslint-plugin-js to 4.0.1
...
- Updated @stylistic/eslint-plugin-js to 4.0.0
...
- Updated @stylistic/eslint-plugin-js to 3.1.0
...
- Updated @stylistic/eslint-plugin-js to 3.0.1
...
- Updated @stylistic/eslint-plugin-js to 3.0.0
...
- Updated @stylistic/eslint-plugin-js to 2.12.1
...
- Updated @stylistic/eslint-plugin-js to 2.12.0
...
- Updated @stylistic/eslint-plugin-js to 2.11.0
...
- Updated @stylistic/eslint-plugin-js to 2.10.1
...
- Updated @stylistic/eslint-plugin-js to 2.9.0
...
- Updated @stylistic/eslint-plugin-js to 2.8.0
- Updated @stylistic/js/indent rule with `'tab', { SwitchCase: 1, VariableDeclarator: 1, outerIIFEBody: 1, MemberExpression: 1, FunctionDeclaration: { parameters: 1, body: 1 }, FunctionExpression: { parameters: 1, body: 1 }, CallExpression: { arguments: 1 }, ArrayExpression: 1, ObjectExpression: 1, ImportDeclaration: 1, flatTernaryExpressions: false, offsetTernaryExpressions: false, ignoreComments: false, tabLength: 4 }`
...
- Updated @stylistic/eslint-plugin-js to 2.7.2
...
- Updated @stylistic/eslint-plugin-js to 2.7.1
...
- Updated @stylistic/eslint-plugin-js to 2.6.5
...
- Updated @stylistic/eslint-plugin-js to 2.6.4
...
- Updated @stylistic/eslint-plugin-js to 2.6.3
...
- Updated @stylistic/eslint-plugin-js to 2.6.2
...
- Updated @stylistic/eslint-plugin-js to 2.6.1
...
- Updated @stylistic/eslint-plugin-js to 2.6.0
...
- Updated @stylistic/eslint-plugin-js to 2.4.0
...
- Updated @stylistic/eslint-plugin-js to 2.3.0
...
- Updated @stylistic/eslint-plugin-js to 2.2.2
...
- Updated @stylistic/eslint-plugin-js to 2.2.1
...
- Updated @stylistic/eslint-plugin-js to 2.2.0
- Updated @stylistic/js/quotes rule with `'single', { avoidEscape: true, allowTemplateLiterals: false, ignoreStringLiterals: false }`
...
- Updated @stylistic/eslint-plugin-js to 2.1.0
...
- Updated @stylistic/eslint-plugin-js to 2.0.0
...
- Updated @stylistic/eslint-plugin-js to 1.8.1
...
- Updated @stylistic/eslint-plugin-js to 1.7.0
...
- Updated @stylistic/eslint-plugin-js to 1.6.2
...
- Updated @stylistic/eslint-plugin-js to 1.6.1
...
- Updated @stylistic/eslint-plugin-js to 1.5.4
...
- Updated eslint to 8.55.0
- Updated @stylistic/eslint-plugin-js to 1.4.1
...
- Enabled prefer-object-has-own rule
...
- Updated eslint to 8.43.0
- Updated no-irregular-whitespace rule with `{ skipStrings: false, skipComments: false, skipRegExps: false, skipTemplates: false, skipJSXText: false }`
...
- Updated semi rule with `'always', { omitLastInOneLineBlock: false, omitLastInOneLineClassBody: false }`
...
- Updated no-underscore-dangle rule with `{ allowAfterThis: false, allowAfterSuper: false, allowAfterThisConstructor: false, enforceInMethodNames: true, enforceInClassFields: true, allowInArrayDestructuring: false, allowInObjectDestructuring: false, allowFunctionParams: false }`
...
- Updated no-use-before-define rule with `{ functions: true, classes: true, variables: true, allowNamedExports: false }`
...
- Updated default-case rule with `{}`
